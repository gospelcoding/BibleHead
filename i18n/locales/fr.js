export default {
  ...
  AddVerses: "Ajouter ces versets",
  AlwaysAsk: "Choisir chaque fois",
  BackingUp: "Sauvegarde en cours...",
  BackupVersesNow: "Créer une sauvegarde des versets",
  ...
  Lang: "Français",
  Language: "Langue",
  LatestBackup: "Dernière sauvegarde : {{datetime}}.\nCode : {{code}}.",
  Learned: "Appris",
  ...
  NetworkError: "Erreur de connexion au server de sauvegardes.",
  NewVerse: "Nouveau verset",
  NewVerseMethod: "Ajouter des versets",
  NoSuchBackup: "Aucune sauvegarde trouvée pour ce code.",
